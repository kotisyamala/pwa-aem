...
@Component(service=Servlet.class,
        property={
                ...
                Constants.SERVICE_VENDOR + "= Building a PWA with AEM",
...
public class ManifestServlet extends HttpServlet {
    ...
    public @interface Configuration {
        ...
        String description() default "PWA is a progressive web application powerded by Adobe Experience Manager";

        @AttributeDefinition(
                name = "short name",
                description = "short name"
        )
        String shortName() default "PWA";

        @AttributeDefinition(
                name = "icons",
                description = "icons"
        )
        String[] icons() default {"{\"src\": \"/etc/clientlibs/pwa/icons/icon-32x32.png\",\"sizes\": \"32x32\"}", "{\"src\": \"/etc/clientlibs/pwa/icons/icon-128x128.png\",\"sizes\": \"128x128\"}", "{\"src\": \"/etc/clientlibs/pwa/icons/icon-144x144.png\",\"sizes\": \"144x144\"}", "{\"src\": \"/etc/clientlibs/pwa/icons/icon-192x192.png\",\"sizes\": \"192x192\"}", "{\"src\": \"/etc/clientlibs/pwa/icons/icon-256x256.png\",\"sizes\": \"256x256\"}"};

        @AttributeDefinition(
                name = "scope",
                description = "scope"
        )
        String scope() default "/content/pwa/";

        @AttributeDefinition(
                name = "startUrl",
                description = "startUrl"
        )
        String startUrl() default "/content/pwa/en.html";
        ...
        String serviceworker() default "{\"src\": \"/content/sw.js\",\"scope\": \"/content/pwa/en.html\",\"update_via_cache\": \"none\"}";
    }
}
