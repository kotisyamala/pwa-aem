...
@Component(service=Servlet.class,
        property={
                ...
                HttpWhiteboardConstants.HTTP_WHITEBOARD_SERVLET_PATTERN+"=/content/service-worker.js" ,
...
public class ServiceWorkerServlet extends HttpServlet {
    ...
    public @interface Configuration {
        ...
        @AttributeDefinition(
                ...
                description = "Location of the service-worker.js file"
        )
        String serviceWorkerPath() default "/etc/clientlibs/pwa/service-worker.js";
